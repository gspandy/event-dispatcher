...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <bean class="com.ctrip.infosec.riskverify.standardMiddlewareImpl.OrderIndexStandard"/>
    <bean class="com.ctrip.infosec.riskverify.handlerImpl.CommonHandler"/>
    <!--<bean id="OrderIndex_Flight" class="com.ctrip.infosec.riskverify.receiverImpl.CMessage" init-method="start">-->
    <bean id="OrderIndex_Flight" class="com.ctrip.infosec.riskverify.receiverImpl.CMessage">
        ...
        <!--<constructor-arg name="target" ref="orderIndex"/>-->
    </bean>

    <!--<bean id="OrderIndex_Activity" class="com.ctrip.infosec.riskverify.receiverImpl.CMessage" init-method="start">-->
